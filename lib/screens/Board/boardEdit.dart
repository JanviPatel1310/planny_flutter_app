...
class BoardEdit extends StatefulWidget {
  BoardEdit({Key key}) : super(key: key);
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<BoardEdit> {
              ...
              TextButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    UpdateBoardRequestModel model = UpdateBoardRequestModel();
                    model.name = _workspacename.text;
                    model.color = _hexcolor.text;
                    await editBoardViewModel.editBoard(model, id);
                    if (editBoardViewModel.editBoardResponse.status ==
                        Status.COMPLETE) {
                      BoardEditResponseModel resModel =
                          editBoardViewModel.editBoardResponse.data;
