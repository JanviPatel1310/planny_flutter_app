...
class BoardCreate extends StatefulWidget {
  BoardCreate({Key key}) : super(key: key);
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<BoardCreate> {
  EditContactViewModel createBoardViewModel = Get.put(EditContactViewModel());
  ...
  TextEditingController _workspaceId = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    _workspaceId.text = id;
    final _formKey = GlobalKey<FormState>();
    // _stationname.text = data;
    return Scaffold(
              ...
              TextButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    BoardCreateRequestModel model = BoardCreateRequestModel();
                    model.workspace_id = _workspaceId.text;
                    model.name = _stationname.text;
                    model.color = _hexcolor.text;
                    await createBoardViewModel.createBoard(model);
                    if (createBoardViewModel.boardCraateResponse.status ==
                        Status.COMPLETE) {
                      BoardCreateResponseModel resModel =
                          createBoardViewModel.boardCraateResponse.data;
