...
class CreateTaskGroup extends StatefulWidget {
  CreateTaskGroup({Key key}) : super(key: key);
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CreateTaskGroup> {
  EditContactViewModel createWorkspaceViewModel =
              ...
              TextButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    CreateTaskGroupRequestModel model =
                        CreateTaskGroupRequestModel();
                    model.name = _stationname.text;
                    model.color = _hexcolor.text;
                    model.boardId = _id.text;
                    await createWorkspaceViewModel.createTaskGroup(model);
                    if (createWorkspaceViewModel.createtaskGroup.status ==
                        Status.COMPLETE) {
                      CreatTaskgrouprResponseModel resModel =
                          createWorkspaceViewModel.createtaskGroup.data;
