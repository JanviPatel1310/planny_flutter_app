...
class TaskGroupEdit extends StatefulWidget {
  TaskGroupEdit({Key key}) : super(key: key);
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<TaskGroupEdit> {
  EditContactViewModel editWorksapceViewModel = Get.put(EditContactViewModel());
  EditContactViewModel editBoardViewModel = Get.put(EditContactViewModel());
              ...
              TextButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    UpdateTaskGroupRequestModel model =
                        UpdateTaskGroupRequestModel();
                    model.name = _workspacename.text;
                    model.color = _hexcolor.text;
                    await editBoardViewModel.editTaskGroup(model, id);
                    if (editBoardViewModel.updatetaskGroup.status ==
                        Status.COMPLETE) {
                      UpdateTaskgrouprResponseModel resModel =
                          editBoardViewModel.updatetaskGroup.data;
