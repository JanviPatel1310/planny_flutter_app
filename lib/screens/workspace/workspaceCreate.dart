...
class WorkspaceCreate extends StatefulWidget {
  WorkspaceCreate({Key key}) : super(key: key);
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<WorkspaceCreate> {
              ...
              TextButton(
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    CreateWorkspaceRequestModel model =
                        CreateWorkspaceRequestModel();
                    model.name = _stationname.text;
                    model.color = _hexcolor.text;
                    await createWorkspaceViewModel.createWorkspace(model);
                    if (createWorkspaceViewModel
                            .createWorkspaceResponse.status ==
                        Status.COMPLETE) {
                      WorkspaceCreateResponseModel resModel =
                          createWorkspaceViewModel.createWorkspaceResponse.data;
